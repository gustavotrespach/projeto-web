...
<div class="flex flex-col items-center w-full overflow-x-auto">
    ...
    <a href="{{ url('pokemons/create') }}" type="button" class="focus:outline-none text-white bg-green-400 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 mt-2 dark:focus:ring-green-900">Create New</a>
</div>
</body>
</html>
